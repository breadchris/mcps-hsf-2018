...
duration = run("ffprobe -v error -show_entries format=duration -of default=noprint_wrappers=1:nokey=1 feed.mp4")
...
while True:
	...
	os.system("cp output{}.jpg /var/www/html/static/output.jpg".format(timestamp.replace(".", "").replace(":", "")))
